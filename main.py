...
You'll be using a subset of this data, 15,000 images for each label (A-J).
"""
...
Implement Min-Max scaling in the normalize() function to a range of a=0.1 and b=0.9. 
...
Min-Max Scaling:  X′=a+(X−Xmin)(b−a)Xmax−XminX′=a+(X−Xmin)(b−a)Xmax−Xmin 
...
"""
Problem 3¶
Below are 3 parameter configurations for training the neural network.
In each configuration, one of the parameters has multiple options.
...
"""
Test
Set the epochs, batch_size, and learning_rate with the best learning parameters you discovered in problem 3.
...
You should have a test accuracy of at least 80%.
"""
